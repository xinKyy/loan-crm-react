  ...
  return (
    <Card>
      <div>
        ...
        <div style={{display:"flex", justifyContent:"space-between", border:"1px solid #000", padding:"0 20px", alignItems:"center", width:"500px"}}>
          <div>自动审批功能</div>
          <div style={{display:"flex", alignItems:"center"}}>
            <div style={{height:"50px", width:"1px", background:"#000", marginRight:"50px"}}></div>
            开
            <div style={{height:"50px", width:"1px", background:"#000", marginLeft:"50px"}}></div>
          </div>
          <div style={{display:'flex'}}>
            <Button type="primary" size="small" onClick={(e) => callBack({})}>
              启动
            </Button>
            <div style={{width:"10px"}}></div>
            <Button type="default" size="small" onClick={(e) => callBack({})}>
              暂停
            </Button>
          </div>
        </div>
